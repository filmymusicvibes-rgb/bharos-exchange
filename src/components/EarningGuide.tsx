      ...
      <div className={`max-w-5xl mx-auto relative transition-all duration-1000 ${
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm sm:text-base max-w-lg mx-auto">
            Just 12 USDT investment — Earn both BRS Coins + USDT Dollars!
          </p>
        </div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 mb-8">
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-500">
              ⏱️ <span className="text-green-400 font-bold">Breakeven:</span> Just 6 members = 12 USDT back! 7th member onwards → PURE PROFIT 💰
            </p>
          </div>
        </div>
